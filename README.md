...
-Created a dbt service accoutnt and configured IAM in BigQuery: project level roles for running BigQuery jobs & dataset-level permissions for writing dbt models (tables/views)
